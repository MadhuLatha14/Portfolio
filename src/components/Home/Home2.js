        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I am a motivated Computer Science graduate passionate about applying technical knowledge to real-world projects.
              <br />
              <br />I am fluent in classics like
              <i>
                <b className="purple"> Java , Python , C , and MySQL. </b>
              </i>
              <br />
              <br />
